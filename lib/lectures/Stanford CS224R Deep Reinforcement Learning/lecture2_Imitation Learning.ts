...
export const cs224rLecture2ImitationLearningQuestions: Question[] = [
...

  {
    ...
    options: [
      { text: "It aims to learn a policy that mimics expert behavior.", isCorrect: true },
      { text: "Training data consists of expert-collected trajectories.", isCorrect: true },
      { text: "The learned policy maps states or observations to actions.", isCorrect: true },
      { text: "The goal is to achieve high task performance without explicitly defining a reward.", isCorrect: true },
    ],
    explanation:
...

  {
    ...
    options: [
      { text: "It reduces imitation learning to supervised learning.", isCorrect: true },
      { text: "The policy is trained to predict expert actions from states.", isCorrect: true },
      { text: "A common loss is squared error between predicted and expert actions.", isCorrect: true },
      { text: "The learned policy can be deployed directly after training.", isCorrect: true },
    ],
    explanation:
...

  {
    ...
    options: [
      { text: "They consist of sequences of states and actions.", isCorrect: true },
      { text: "They are assumed to come from an unknown expert policy.", isCorrect: true },
      { text: "They define the data distribution used for training.", isCorrect: true },
      { text: "They may contain variability due to different human strategies.", isCorrect: true },
    ],
    explanation:
...

  {
    ...
    chapter: 2,
    difficulty: "medium",
    prompt: "Which statements correctly describe multimodality in imitation learning data?",
    options: [
      { text: "Different experts may choose different valid actions in the same state.", isCorrect: true },
      { text: "Multimodality leads to multiple peaks in the action distribution.", isCorrect: true },
      { text: "Averaging expert actions can produce low-probability behaviors.", isCorrect: true },
      { text: "Multimodality is common in human-collected datasets.", isCorrect: true },
    ],
    explanation:
...

  {
    ...
    chapter: 2,
    difficulty: "medium",
    prompt: "Which statements correctly describe why deterministic L2 regression can fail?",
    options: [
      { text: "It predicts the mean of the action distribution.", isCorrect: true },
      { text: "The mean action may have low probability under the data.", isCorrect: true },
      { text: "It cannot represent multiple distinct expert strategies.", isCorrect: true },
      { text: "Increasing network size does not fix distributional collapse.", isCorrect: true },
    ],
    explanation:
...

  {
    ...
    chapter: 2,
    difficulty: "medium",
    prompt: "Which statements correctly describe expressive policy distributions?",
    options: [
      { text: "They represent full action distributions rather than single actions.", isCorrect: true },
      { text: "They can capture multimodal expert behavior.", isCorrect: true },
      { text: "They are typically trained by maximizing log-likelihood of demonstrations.", isCorrect: true },
      { text: "They reduce the risk of implausible averaged actions.", isCorrect: true },
    ],
    explanation:
...

  {
    ...
    chapter: 2,
    difficulty: "hard",
    prompt: "Which statements correctly describe learning a policy via maximum likelihood?",
    options: [
      { text: "The objective minimizes negative log probability of expert actions.", isCorrect: true },
      { text: "The policy defines a probability distribution π(a|s).", isCorrect: true },
      { text: "Training maximizes agreement with demonstrated behavior.", isCorrect: true },
      { text: "The learned policy induces a distribution over trajectories.", isCorrect: true },
    ],
    explanation:
...

  {
    ...
    chapter: 2,
    difficulty: "hard",
    prompt: "Which statements correctly describe autoregressive action modeling?",
    options: [
      { text: "Actions are modeled one dimension at a time.", isCorrect: true },
      { text: "Each dimension is conditioned on previously generated dimensions.", isCorrect: true },
      { text: "The full joint distribution factorizes autoregressively.", isCorrect: true },
      { text: "This approach scales to high-dimensional actions.", isCorrect: true },
    ],
    explanation:
...

  {
    ...
    chapter: 2,
    difficulty: "hard",
    prompt: "Which statements correctly describe diffusion policies for imitation learning?",
    options: [
      { text: "They generate actions via iterative denoising.", isCorrect: true },
      { text: "They can model complex continuous action distributions.", isCorrect: true },
      { text: "Sampling requires multiple refinement steps.", isCorrect: true },
      { text: "They are more expressive than single Gaussian policies.", isCorrect: true },
    ],
    explanation:
...

  {
    ...
    options: [
      ...
      { text: "They define the training distribution for imitation learning.", isCorrect: true },
      { text: "They always correspond to optimal behavior.", isCorrect: false },
      { text: "They may include inconsistent action choices.", isCorrect: true },
    ],
    explanation:
...

  {
    ...
    chapter: 2,
    difficulty: "medium",
    prompt: "Which statements about Gaussian mixture models (GMMs) are correct?",
    options: [
      { text: "They combine multiple Gaussian components.", isCorrect: true },
      { text: "They are more expressive than a single Gaussian.", isCorrect: true },
      { text: "They require choosing the number of components.", isCorrect: true },
      { text: "They are maximally expressive for continuous actions.", isCorrect: false },
    ],
    explanation:
...

  {
    ...
    chapter: 2,
    difficulty: "medium",
    prompt: "Which statements about discretization in imitation learning are correct?",
    options: [
      { text: "Continuous actions can be binned into discrete categories.", isCorrect: true },
      { text: "Discretization enables categorical cross-entropy loss.", isCorrect: true },
      { text: "Finer discretization increases expressivity.", isCorrect: true },
      { text: "Discretization preserves exact distance information between actions.", isCorrect: false },
    ],
    explanation:
...

  {
    ...
    options: [
      { text: "It trains using a fixed dataset of demonstrations.", isCorrect: true },
      { text: "It does not require running the learned policy during training.", isCorrect: true },
      { text: "It avoids safety risks from untrained policies.", isCorrect: true },
      { text: "It guarantees robustness to compounding errors.", isCorrect: false },
    ],
    explanation:
...

  {
    ...
    options: [
      { text: "They arise when policy mistakes alter future states.", isCorrect: true },
      { text: "They cause the policy to visit unseen states.", isCorrect: true },
      { text: "They create a mismatch between training and deployment distributions.", isCorrect: true },
...

  {
    ...
    options: [
      { text: "It collects data by running the learned policy.", isCorrect: true },
      { text: "It queries the expert at visited states.", isCorrect: true },
      { text: "It aggregates corrective data with original demonstrations.", isCorrect: true },
...

  {
    ...
    chapter: 2,
    difficulty: "easy",
    prompt: "Which statements about categorical policies for discrete actions are correct?",
    options: [
      { text: "They output probabilities over discrete actions.", isCorrect: true },
      { text: "They are maximally expressive for discrete action spaces.", isCorrect: true },
      { text: "They are trained using classification losses.", isCorrect: true },
      { text: "They require continuous action representations.", isCorrect: false },
    ],
    explanation:
...

  {
    ...
    options: [
      { text: "Distribution expressivity differs from network expressivity.", isCorrect: true },
      { text: "A large network with L2 loss still predicts a mean.", isCorrect: true },
      { text: "Expressive distributions enable safer action sampling.", isCorrect: true },
      { text: "Distribution choice is irrelevant if the network is deep enough.", isCorrect: false },
    ],
    explanation:
...

  {
    ...
    chapter: 2,
    difficulty: "medium",
    prompt: "Which statements about training autoregressive policies are correct?",
    options: [
      { text: "Training uses expert actions as conditioning inputs.", isCorrect: true },
      { text: "Cross-entropy loss is applied per action dimension.", isCorrect: true },
      { text: "Inference feeds sampled actions back into the model.", isCorrect: true },
      { text: "Backpropagation requires differentiating through sampled actions.", isCorrect: false },
    ],
    explanation:
...

  {
    ...
    chapter: 2,
    difficulty: "medium",
    prompt: "Which statements about discretized autoregressive policies are correct?",
    options: [
      ...
      { text: "They reduce modeling complexity of joint distributions.", isCorrect: true },
...

  {
    ...
    options: [
      { text: "It arises when policy actions affect future states.", isCorrect: true },
      { text: "It causes mismatch between expert and policy state distributions.", isCorrect: true },
      { text: "It is irrelevant when demonstrations are large.", isCorrect: false },
      { text: "It can be ignored in sequential decision problems.", isCorrect: false },
    ],
    explanation:
...

  {
    ...
    options: [
      ...
      { text: "Corrections are collected without policy rollouts.", isCorrect: false },
      { text: "It is more practical than querying every visited state.", isCorrect: true },
      { text: "It eliminates the need for expert involvement.", isCorrect: false },
    ],
    explanation:
...

  {
    ...
    options: [
      ...
      { text: "They generate actions in a single forward pass.", isCorrect: false },
      { text: "They require discretization of actions.", isCorrect: false },
      { text: "They handle multimodal continuous actions well.", isCorrect: true },
    ],
    explanation:
...

  {
    ...
    options: [
      ...
      { text: "They enable sampling from high-probability regions.", isCorrect: true },
    ],
    explanation:
...

  {
    ...
    options: [
      ...
      { text: "They can represent arbitrary action distributions.", isCorrect: false },
      { text: "They are limited for multimodal imitation data.", isCorrect: true },
...

  {
    ...
    options: [
      { text: "Imitation learning assumes expert behavior is optimal.", isCorrect: false },
      { text: "Experts may follow different strategies.", isCorrect: true },
      { text: "Imitation learning can outperform experts by default.", isCorrect: false },
      { text: "Imitation learning aims to match expert performance.", isCorrect: true },
    ],
    explanation:
...

  {
    ...
    options: [
      ...
      { text: "Training and deployment distributions are identical.", isCorrect: false },
...

  {
    ...
    options: [
      { text: "It always requires online interaction with the environment.", isCorrect: false },
      { text: "It inherently solves long-horizon planning.", isCorrect: false },
      { text: "It can suffer from covariate shift.", isCorrect: true },
      { text: "It guarantees stable performance without interventions.", isCorrect: false },
    ],
    explanation:
...

  {
    ...
    chapter: 2,
    difficulty: "hard",
    prompt: "Which statement about negative log-likelihood training is correct?",
    options: [
      { text: "It minimizes squared error between actions.", isCorrect: false },
      { text: "It maximizes reward directly.", isCorrect: false },
      { text: "It fits a probabilistic model to expert actions.", isCorrect: true },
      { text: "It removes the need for expressive distributions.", isCorrect: false },
    ],
    explanation:
...

  {
    ...
    options: [
      ...
      { text: "They require expressive policy distributions.", isCorrect: true },
...

  {
    ...
    options: [
      ...
      { text: "It is less data-efficient than offline cloning.", isCorrect: false },
...

  {
    ...
    options: [
      { text: "They are unnecessary for single-expert datasets.", isCorrect: false },
      { text: "They only matter for large neural networks.", isCorrect: false },
      { text: "They improve robustness under expert diversity.", isCorrect: true },
      { text: "They replace the need for state representation.", isCorrect: false },
    ],
    explanation:
...

  {
    ...
    options: [
      { text: "It predicts all action dimensions simultaneously.", isCorrect: false },
      { text: "It ignores correlations between action dimensions.", isCorrect: false },
...

  {
    ...
    options: [
      { text: "It can improve beyond expert performance by default.", isCorrect: false },
      { text: "It provides a mechanism for self-improvement through exploration.", isCorrect: false },
      { text: "Its performance is bounded by demonstration quality.", isCorrect: true },
...

  {
    ...
    options: [
      ...
      { text: "They arise because actions affect future states.", isCorrect: true },
