...
export const cs224rLecture4ActorCriticQuestions: Question[] = [
...

  {
    ...
    chapter: 4,
    difficulty: "easy",
    prompt: "Which statements correctly describe the value function \\(V^\\pi(s)\\)?",
    options: [
      { text: "It represents expected future rewards when following policy \\(\\pi\\) from state \\(s\\).", isCorrect: true },
      { text: "It depends on both the policy and environment dynamics.", isCorrect: true },
      { text: "It can be interpreted as a probability of success in some tasks.", isCorrect: true },
      { text: "It is defined as an expectation over trajectories starting at \\(s\\).", isCorrect: true }
    ],
    explanation:
...

  {
    ...
    chapter: 4,
    difficulty: "easy",
    prompt: "Which statements correctly describe the Q-function \\(Q^\\pi(s,a)\\)?",
    options: [
      { text: "It measures expected return after taking action \\(a\\) in state \\(s\\) and then following \\(\\pi\\).", isCorrect: true },
      { text: "It differs from \\(V^\\pi(s)\\) by conditioning on the first action.", isCorrect: true },
      { text: "It marginalizes over future stochastic transitions.", isCorrect: true },
      { text: "It includes immediate reward plus expected future rewards.", isCorrect: true }
    ],
    explanation:
...

  {
    ...
    chapter: 4,
    difficulty: "easy",
    prompt: "Which statements about the advantage function \\(A^\\pi(s,a)\\) are correct?",
    options: [
      { text: "\\(A^\\pi(s,a) = Q^\\pi(s,a) - V^\\pi(s)\\).", isCorrect: true },
      { text: "It measures how much better an action is than the policy’s average choice.", isCorrect: true },
      { text: "Positive advantage implies the action is better than expected.", isCorrect: true },
      { text: "It centers Q-values around the state value baseline.", isCorrect: true }
    ],
    explanation:
...

  {
    ...
    options: [
      { text: "They use a critic to estimate value functions.", isCorrect: true },
      { text: "They use advantage estimates to update the actor.", isCorrect: true },
      { text: "They improve sample efficiency compared to vanilla policy gradients.", isCorrect: true },
      { text: "They consist of two separate parameterized models.", isCorrect: true }
    ],
    explanation:
...

  {
    ...
    options: [
      { text: "Targets are full returns \\(G_t = \\sum_{t'=t}^T r_{t'}\\).", isCorrect: true },
      { text: "It is unbiased.", isCorrect: true },
      { text: "It suffers from high variance.", isCorrect: true },
      { text: "It does not rely on bootstrapped predictions.", isCorrect: true }
    ],
    explanation:
...

  {
    ...
    options: [
      ...
      { text: "It bootstraps from the current value estimate.", isCorrect: true },
      { text: "It reduces variance relative to Monte Carlo.", isCorrect: true },
      { text: "It introduces bias when value estimates are inaccurate.", isCorrect: true }
    ],
    explanation:
...

  {
    ...
    options: [
      { text: "\\(y_t = \\sum_{k=0}^{n-1} \\gamma^k r_{t+k} + \\gamma^n V(s_{t+n})\\).", isCorrect: true },
...

  {
    ...
    options: [
      ...
      { text: "It prevents divergence for infinite horizons.", isCorrect: true },
      { text: "It is equivalent to adding a termination probability \\(1-\\gamma\\).", isCorrect: true },
      { text: "Transition probabilities are scaled by \\(\\gamma\\).", isCorrect: true }
    ],
    explanation:
...

  {
    ...
    chapter: 4,
    difficulty: "easy",
    prompt: "Which statements about advantage-based policy updates are correct?",
    options: [
      { text: "Actions with positive advantage are reinforced.", isCorrect: true },
...

  {
    ...
    chapter: 4,
    difficulty: "medium",
    prompt: "Which statements about learning \\(V^\\pi\\) with supervised learning are correct?",
    options: [
      { text: "Training data pairs states with observed returns.", isCorrect: true },
      { text: "The loss is typically \\(L = (V_\\phi(s) - y)^2\\).", isCorrect: true },
      { text: "The labels remain fixed during training.", isCorrect: false },
      { text: "Multiple trajectories provide amortized supervision.", isCorrect: true }
    ],
    explanation:
...

  {
    ...
    options: [
      { text: "It only uses rewards from the sampled trajectory.", isCorrect: true },
      { text: "Similar states across trajectories are not linked.", isCorrect: true },
...

  {
    ...
    options: [
      ...
      { text: "They can diverge if policies differ too much.", isCorrect: true },
...

  {
    ...
    chapter: 4,
    difficulty: "easy",
    prompt: "Which statements about actor–critic vs policy gradient are correct?",
    options: [
...

  {
    ...
    options: [
      { text: "Errors in the critic propagate into the policy update.", isCorrect: true },
      { text: "Biased value estimates lead to biased advantages.", isCorrect: true },
...

  {
    ...
    options: [
      ...
      { text: "n-step can reduce variance compared to Monte Carlo.", isCorrect: true }
    ],
    explanation:
...

  {
    ...
    explanation:
      "The actor selects actions while the critic evaluates them."
  },
...

  {
    ...
    explanation:
      "Critic updates are independent supervised learning steps."
  },
...

  {
    ...
    options: [
      { text: "Can learn from partial progress trajectories.", isCorrect: true },
      { text: "More efficient than sparse reward policy gradients.", isCorrect: true },
      { text: "Requires full reward success trajectories only.", isCorrect: false },
      { text: "Ignores failed rollouts.", isCorrect: false }
    ],
    explanation:
      "Critic extracts signal even from imperfect rollouts."
  },
...

  {
    ...
    explanation:
      "TD uses one-step reward plus estimated value."
  },
...

  {
    ...
    explanation:
      "Monte Carlo uses full returns directly."
  },

  {
    ...
    options: [
      ...
      { text: "Gamma less than one reduces long-term reward weight.", isCorrect: true },
      { text: "Gamma eliminates variance.", isCorrect: false },
      { text: "Gamma only affects policy network.", isCorrect: false }
    ],
    explanation:
      "Discounting exponentially shrinks distant rewards."
  },

  {
    ...
    explanation:
      "Actor relies directly on critic estimates."
  },

  {
    ...
    explanation:
      "n-step mixes rewards and predicted values."
  },

  {
    ...
    options: [
      ...
      { text: "Uses learned value estimates for better gradients.", isCorrect: true },
      { text: "Does not require learning.", isCorrect: false },
      { text: "Always unstable.", isCorrect: false }
    ],
    explanation:
      "The critic reduces variance and improves data use."
  }
