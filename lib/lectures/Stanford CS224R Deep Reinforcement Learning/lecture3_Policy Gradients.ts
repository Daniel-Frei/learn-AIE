...
export const cs224rLecture3PolicyGradientsQuestions: Question[] = [
...

  {
    ...
    options: [
      { text: "The objective is to maximize expected cumulative reward.", isCorrect: true },
      { text: "The expectation is taken over trajectories induced by the policy.", isCorrect: true },
      { text: "The trajectory distribution depends on both the policy and environment dynamics.", isCorrect: true },
      { text: "The objective can be written as \\( J(\\theta) = \\mathbb{E}_{\\tau \\sim p_\\theta(\\tau)}[\\sum_t r(s_t, a_t)] \\).", isCorrect: true },
    ],
    explanation:
...

  {
    ...
    chapter: 3,
    difficulty: "easy",
    prompt: "Which statements correctly describe online reinforcement learning?",
    options: [
      { text: "The policy is updated using data collected from its own execution.", isCorrect: true },
      { text: "Data collection and learning are interleaved.", isCorrect: true },
      { text: "The policy improves through trial and error.", isCorrect: true },
      { text: "The data distribution changes as the policy changes.", isCorrect: true },
    ],
    explanation:
...

  {
    ...
    chapter: 3,
    difficulty: "easy",
    prompt: "Which statements correctly describe a policy \\(\\pi_\\theta(a\\mid s)\\)?",
    options: [
      { text: "It defines a probability distribution over actions.", isCorrect: true },
      { text: "It is typically parameterized by a neural network.", isCorrect: true },
      { text: "It induces a distribution over trajectories.", isCorrect: true },
      { text: "Its parameters are optimized to increase expected reward.", isCorrect: true },
    ],
    explanation:
...

  {
    ...
    chapter: 3,
    difficulty: "medium",
    prompt: "Which statements correctly describe the probability of a trajectory \\(p_\\theta(\\tau)\\)?",
    options: [
      { text: "\\(p_\\theta(\\tau) = p(s_1) \\prod_t \\pi_\\theta(a_t\\mid s_t) p(s_{t+1}\\mid s_t, a_t)\\).", isCorrect: true },
      { text: "It factorizes into policy and environment dynamics terms.", isCorrect: true },
      { text: "The initial state distribution does not depend on \\(\\theta\\).", isCorrect: true },
      { text: "Environment transition probabilities are independent of \\(\\theta\\).", isCorrect: true },
    ],
    explanation:
...

  {
    ...
    chapter: 3,
    difficulty: "medium",
    prompt: "Which statements correctly describe the REINFORCE (vanilla policy gradient) algorithm?",
    options: [
      { text: "It estimates gradients using sampled trajectories.", isCorrect: true },
      { text: "It applies gradient ascent to policy parameters.", isCorrect: true },
...

  {
    ...
    options: [
      { text: "\\(\\nabla_\\theta p_\\theta(x) = p_\\theta(x) \\nabla_\\theta \\log p_\\theta(x)\\).", isCorrect: true },
      { text: "It allows gradients to be moved inside an expectation.", isCorrect: true },
      { text: "It avoids differentiating through the sampling operation.", isCorrect: true },
      { text: "It is central to policy gradient derivations.", isCorrect: true },
    ],
    explanation:
...

  {
    ...
    options: [
      { text: "\\(\\nabla_\\theta J(\\theta) = \\mathbb{E}_{\\tau}[\\nabla_\\theta \\log p_\\theta(\\tau) r(\\tau)]\\).", isCorrect: true },
      { text: "Only the policy terms contribute to the gradient.", isCorrect: true },
      { text: "The gradient does not require knowing environment dynamics.", isCorrect: true },
      { text: "The expectation can be estimated with Monte Carlo samples.", isCorrect: true },
    ],
    explanation:
...

  {
    ...
    chapter: 3,
    difficulty: "hard",
    prompt: "Which statements correctly describe the gradient \\(\\nabla_\\theta \\log p_\\theta(\\tau)\\)?",
    options: [
      { text: "\\(\\nabla_\\theta \\log p_\\theta(\\tau) = \\sum_t \\nabla_\\theta \\log \\pi_\\theta(a_t\\mid s_t)\\).", isCorrect: true },
      { text: "Gradients of initial state probabilities vanish.", isCorrect: true },
...

  {
    ...
    chapter: 3,
    difficulty: "hard",
    prompt: "Which statements correctly describe the intuition of policy gradients?",
    options: [
      { text: "Actions in high-reward trajectories become more likely.", isCorrect: true },
      { text: "Actions in low-reward trajectories become less likely.", isCorrect: true },
      { text: "The policy imitates its own successful behavior.", isCorrect: true },
      { text: "Learning corresponds to trial-and-error optimization.", isCorrect: true },
    ],
    explanation:
...

  {
    ...
    options: [
      ...
      { text: "Policies can be initialized via imitation learning.", isCorrect: true },
      { text: "Initialization affects early exploration.", isCorrect: true },
      { text: "Initialization determines the optimal final policy.", isCorrect: false },
    ],
    explanation:
...

  {
    ...
    chapter: 3,
    difficulty: "medium",
    prompt: "Which statements about Monte Carlo estimation of \\(J(\\theta)\\) are correct?",
    options: [
      { text: "It approximates expectations using sampled trajectories.", isCorrect: true },
      { text: "Variance decreases as the number of samples increases.", isCorrect: true },
      { text: "It requires differentiating through the environment.", isCorrect: false },
      { text: "It provides an unbiased estimate of expected return.", isCorrect: true },
    ],
    explanation:
...

  {
    ...
    chapter: 3,
    difficulty: "medium",
    prompt: "Which statements about reward weighting in policy gradients are correct?",
    options: [
      { text: "Higher rewards scale gradients upward.", isCorrect: true },
      { text: "Negative rewards can reverse gradient direction.", isCorrect: true },
      { text: "Reward scaling affects variance.", isCorrect: true },
      { text: "Reward scaling does not affect learning dynamics.", isCorrect: false },
    ],
    explanation:
...

  {
    ...
    options: [
      ...
      { text: "Using future rewards reduces gradient variance.", isCorrect: true },
      { text: "Returns are often defined as \\(G_t = \\sum_{t'=t}^T r_{t'}\\).", isCorrect: true },
      { text: "Causality introduces bias into the gradient.", isCorrect: false },
    ],
    explanation:
...

  {
    ...
    options: [
      { text: "Baselines reduce variance of gradient estimates.", isCorrect: true },
      { text: "Baselines must not depend on the action.", isCorrect: true },
      { text: "Subtracting a constant baseline biases the gradient.", isCorrect: false },
...

  {
    ...
    options: [
      { text: "\\(\\mathbb{E}[\\nabla_\\theta \\log p_\\theta(\\tau) b] = 0\\).", isCorrect: true },
      { text: "This follows from \\(\\int p_\\theta(\\tau) d\\tau = 1\\).", isCorrect: true },
...

  {
    ...
    options: [
      ...
      { text: "Policy gradients work best with dense rewards.", isCorrect: true },
      { text: "Sparse rewards guarantee faster convergence.", isCorrect: false },
    ],
    explanation:
...

  {
    ...
    options: [
      { text: "It has the same gradient as the true objective.", isCorrect: true },
      { text: "It enables efficient automatic differentiation.", isCorrect: true },
      { text: "It avoids computing many separate backward passes.", isCorrect: true },
...

  {
    ...
    options: [
      ...
      { text: "Variance is zero for deterministic policies.", isCorrect: false },
...

  {
    ...
    chapter: 3,
    difficulty: "easy",
    prompt: "Which statements about imitation learning versus policy gradients are correct?",
    options: [
      { text: "Policy gradients can outperform demonstrators.", isCorrect: true },
      ...
      { text: "Imitation learning improves through trial and error.", isCorrect: false },
    ],
    explanation:
...

  {
    ...
    options: [
      { text: "It reweights samples from a proposal distribution.", isCorrect: true },
      { text: "It requires \\(q(x) > 0\\) whenever \\(p(x) > 0\\).", isCorrect: true },
...

  {
    ...
    options: [
      { text: "They allow multiple gradient steps per batch.", isCorrect: true },
...

  {
    ...
    chapter: 3,
    difficulty: "hard",
    prompt: "Which statements about trajectory-level importance sampling are correct?",
    options: [
      { text: "It involves a product of per-step probability ratios.", isCorrect: true },
...

  {
    ...
    chapter: 3,
    difficulty: "medium",
    prompt: "Which statements about per-timestep importance sampling are correct?",
    options: [
      { text: "It approximates trajectory-level importance sampling.", isCorrect: true },
      { text: "It reduces variance compared to full products.", isCorrect: true },
...

  {
    ...
    options: [
      { text: "\\(G_t\\) sums rewards from time \\(t\\) onward.", isCorrect: true },
...

  {
    ...
    options: [
      ...
      { text: "It estimates gradients from on-policy rollouts.", isCorrect: true },
...

  {
    ...
    options: [
      ...
      { text: "They reduce variance without changing expectation.", isCorrect: true },
...

  {
    ...
    options: [
      ...
      { text: "They are unnecessary in off-policy learning.", isCorrect: false },
...

  {
    ...
    options: [
      { text: "Variance decreases with smaller batch sizes.", isCorrect: false },
      { text: "Variance is unaffected by reward design.", isCorrect: false },
      { text: "Variance is a major practical challenge.", isCorrect: true },
      { text: "Variance disappears in continuous action spaces.", isCorrect: false },
    ],
    explanation:
...

  {
    ...
    options: [
      { text: "They are always more stable than on-policy methods.", isCorrect: false },
...

  {
    ...
    chapter: 3,
    difficulty: "easy",
    prompt: "Which statement best summarizes the intuition of policy gradients?",
    options: [
      { text: "Copy expert demonstrations.", isCorrect: false },
      { text: "Predict rewards directly.", isCorrect: false },
      { text: "Do more high-reward actions and less low-reward actions.", isCorrect: true },
...

  {
    ...
    options: [
      { text: "Exact gradients can be computed analytically.", isCorrect: false },
      { text: "Gradients require differentiating through the environment.", isCorrect: false },
      { text: "Gradients are estimated using sampled trajectories.", isCorrect: true },
...

  {
    ...
    options: [
      ...
      { text: "They form the foundation of actor-critic methods.", isCorrect: true },
