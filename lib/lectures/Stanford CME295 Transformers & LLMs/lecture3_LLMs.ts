...
export const stanfordCME295Lecture3LLMsQuestions: Question[] = [
...

  {
    ...
    options: [
      { text: "It assigns probabilities to sequences of tokens.", isCorrect: true },
      { text: "It models the likelihood of the next token given previous tokens.", isCorrect: true },
      { text: "Its predictions are based on a learned statistical or neural representation.", isCorrect: true },
      { text: "It can be used to generate text by repeatedly predicting next tokens.", isCorrect: true },
    ],
    explanation:
...

  {
    ...
    chapter: 3,
    difficulty: "easy",
    prompt: "Which statements correctly characterize modern large language models (LLMs)?",
    options: [
      { text: "They typically contain billions or more parameters.", isCorrect: true },
      { text: "They are trained on extremely large datasets measured in tokens.", isCorrect: true },
      { text: "They require substantial computational resources for training.", isCorrect: true },
      { text: "They are commonly implemented using Transformer architectures.", isCorrect: true },
    ],
    explanation:
...

  {
    ...
    chapter: 3,
    difficulty: "easy",
    prompt: "Which statements correctly describe decoder-only Transformer models?",
    options: [
      { text: "They use masked self-attention to prevent access to future tokens.", isCorrect: true },
      { text: "They predict tokens autoregressively.", isCorrect: true },
      { text: "They remove the encoder and cross-attention components.", isCorrect: true },
      { text: "They are commonly used for text-to-text generation tasks.", isCorrect: true },
    ],
    explanation:
...

  {
    ...
    chapter: 3,
    difficulty: "medium",
    prompt: "Which statements correctly describe Mixture-of-Experts (MoE) models?",
    options: [
      { text: "They consist of multiple expert subnetworks.", isCorrect: true },
      { text: "A gating or routing mechanism selects which experts to use.", isCorrect: true },
      { text: "They aim to increase model capacity without activating all parameters.", isCorrect: true },
      { text: "They can reduce inference compute compared to dense models.", isCorrect: true },
    ],
    explanation:
...

  {
    ...
    options: [
      { text: "Only a subset of experts is activated for each input.", isCorrect: true },
      { text: "The number of active experts is typically controlled by a hyperparameter K.", isCorrect: true },
      { text: "They are designed to save compute during forward passes.", isCorrect: true },
      { text: "They rely on a routing mechanism to select experts.", isCorrect: true },
    ],
    explanation:
...

  {
    ...
    chapter: 3,
    difficulty: "medium",
    prompt: "Which statements correctly describe the role of FLOPs in LLM discussions?",
    options: [
      { text: "FLOPs count floating point operations such as additions and multiplications.", isCorrect: true },
      { text: "They are used as a proxy for computational cost.", isCorrect: true },
      { text: "They depend on model architecture and input length.", isCorrect: true },
      { text: "They are commonly used to compare dense and sparse models.", isCorrect: true },
    ],
    explanation:
...

  {
    ...
    chapter: 3,
    difficulty: "easy",
    prompt: "Which statements correctly describe next-token prediction in LLMs?",
    options: [
      { text: "The model outputs a probability distribution over the vocabulary.", isCorrect: true },
      { text: "The distribution is typically produced using a softmax layer.", isCorrect: true },
      { text: "Each decoding step conditions on previously generated tokens.", isCorrect: true },
      { text: "The process is repeated until a stopping condition is met.", isCorrect: true },
    ],
    explanation:
...

  {
    ...
    chapter: 3,
    difficulty: "medium",
    prompt: "Which statements correctly describe temperature in token sampling?",
    options: [
      { text: "Temperature rescales logits before the softmax.", isCorrect: true },
      { text: "Lower temperatures make the distribution more peaked.", isCorrect: true },
      { text: "Higher temperatures make the distribution more uniform.", isCorrect: true },
      { text: "Temperature affects diversity of generated text.", isCorrect: true },
    ],
    explanation:
...

  {
    ...
    options: [
      { text: "It allows models to adapt behavior without changing weights.", isCorrect: true },
      { text: "It relies on information provided in the prompt context.", isCorrect: true },
      { text: "Few-shot learning provides example input–output pairs.", isCorrect: true },
      { text: "Zero-shot learning uses instructions without examples.", isCorrect: true },
    ],
    explanation:
...

  {
    ...
    options: [
      { text: "They are typically used for representation learning tasks.", isCorrect: true },
      { text: "They output contextual embeddings for input tokens.", isCorrect: true },
      { text: "They commonly use a special classification token for downstream tasks.", isCorrect: true },
      { text: "They are primarily designed for autoregressive text generation.", isCorrect: false },
    ],
    explanation:
...

  {
    ...
    options: [
      { text: "It selects the token with the highest probability at each step.", isCorrect: true },
      { text: "It is deterministic given fixed model outputs.", isCorrect: true },
      { text: "It can lead to locally optimal but globally suboptimal sequences.", isCorrect: true },
...

  {
    ...
    options: [
      { text: "It keeps multiple candidate sequences during generation.", isCorrect: true },
      { text: "It aims to approximate globally high-probability sequences.", isCorrect: true },
      { text: "It is commonly used in tasks like machine translation.", isCorrect: true },
      { text: "It always produces highly diverse and creative outputs.", isCorrect: false },
    ],
    explanation:
...

  {
    ...
    options: [
      { text: "It restricts sampling to the k most probable tokens.", isCorrect: true },
      { text: "It prevents extremely low-probability tokens from being sampled.", isCorrect: true },
      { text: "It introduces stochasticity into generation.", isCorrect: true },
      { text: "It guarantees selection of the most probable token.", isCorrect: false },
    ],
    explanation:
...

  {
    ...
    chapter: 3,
    difficulty: "hard",
    prompt: "Which statements about routing collapse in MoE models are correct?",
    options: [
      { text: "It occurs when only a few experts receive most inputs.", isCorrect: true },
      { text: "It can reduce effective model capacity.", isCorrect: true },
      { text: "Auxiliary losses can encourage more balanced expert usage.", isCorrect: true },
...

  {
    ...
    chapter: 3,
    difficulty: "hard",
    prompt: "Which statements about expert routing in Transformers are correct?",
    options: [
      { text: "Routing decisions can be made at the token level.", isCorrect: true },
      { text: "Different layers may route tokens to different experts.", isCorrect: true },
      { text: "The router is typically a learned function.", isCorrect: true },
      { text: "Routing decisions are fixed and not trainable.", isCorrect: false },
    ],
    explanation:
...

  {
    ...
    options: [
      { text: "It constrains which tokens are allowed during generation.", isCorrect: true },
      { text: "It can enforce structured output formats such as JSON.", isCorrect: true },
...

  {
    ...
    options: [
      { text: "It refers to the number of tokens a model can process at once.", isCorrect: true },
      { text: "It is also called context window or context size.", isCorrect: true },
      { text: "Increasing it always improves model accuracy.", isCorrect: false },
      { text: "It affects computational cost of self-attention.", isCorrect: true },
    ],
    explanation:
...

  {
    ...
    options: [
      { text: "It encourages models to produce intermediate reasoning steps.", isCorrect: true },
      { text: "It often improves performance on reasoning tasks.", isCorrect: true },
...

  {
    ...
    options: [
      ...
      { text: "They are well suited for sequence-to-sequence tasks.", isCorrect: true },
      { text: "They rely exclusively on masked self-attention.", isCorrect: false },
...

  {
    ...
    options: [
      { text: "It samples from the smallest set of tokens whose cumulative probability exceeds p.", isCorrect: true },
      { text: "It adapts the candidate set size dynamically.", isCorrect: true },
...

  {
    ...
    options: [
      { text: "It converts logits into a probability distribution.", isCorrect: true },
...

  {
    ...
    options: [
      { text: "It aggregates answers from multiple sampled reasoning paths.", isCorrect: true },
...

  {
    ...
    chapter: 3,
    difficulty: "medium",
    prompt: "Which statements about routing probability in MoE models are correct?",
    options: [
      { text: "It can be produced using a softmax over experts.", isCorrect: true },
      { text: "It indicates how likely an expert is to be selected.", isCorrect: true },
...

  {
    ...
    chapter: 3,
    difficulty: "hard",
    prompt: "Which statements about sample efficiency of MoE models are correct?",
    options: [
      { text: "They can reach strong performance with fewer training steps.", isCorrect: true },
      { text: "They increase total parameter count without proportional compute increase.", isCorrect: true },
...

  {
    ...
    options: [
      { text: "They are raw scores output by a model before softmax.", isCorrect: true },
...

  {
    ...
    options: [
      { text: "The Transformer computations are deterministic given fixed inputs.", isCorrect: true },
      { text: "Sampling introduces nondeterminism.", isCorrect: true },
      { text: "Temperature zero guarantees identical outputs in practice.", isCorrect: false },
      { text: "Hardware effects can introduce nondeterminism.", isCorrect: false },
    ],
    explanation:
...

  {
    ...
    chapter: 3,
    difficulty: "medium",
    prompt: "Which statements about expert placement in Transformers are correct?",
    options: [
      { text: "Experts are commonly placed in the feed-forward network block.", isCorrect: true },
      { text: "This is because the feed-forward block has many parameters.", isCorrect: true },
      { text: "Experts replace the attention mechanism.", isCorrect: false },
      { text: "Experts remove the need for normalization layers.", isCorrect: false },
    ],
    explanation:
...

  {
    ...
    options: [
      { text: "A small neural network trained on labeled data only.", isCorrect: false },
      { text: "A language model with large parameter count, data, and compute.", isCorrect: true },
...

  {
    ...
    options: [
      { text: "It samples from a truncated probability distribution.", isCorrect: false },
      { text: "It selects the highest-probability token at each step.", isCorrect: true },
      { text: "It maintains multiple candidate sequences.", isCorrect: false },
      { text: "It requires auxiliary losses during training.", isCorrect: false },
    ],
    explanation:
...

  {
    ...
    chapter: 3,
    difficulty: "medium",
    prompt: "Which statement correctly explains why beam search can prefer shorter sequences?",
    options: [
      { text: "Probabilities greater than one accumulate with length.", isCorrect: false },
      { text: "Multiplying probabilities less than one reduces total sequence probability.", isCorrect: true },
      { text: "Beam search ignores end-of-sequence tokens.", isCorrect: false },
      { text: "Beam search uses temperature scaling by default.", isCorrect: false },
    ],
    explanation:
...

  {
    ...
    options: [
      ...
      { text: "Only a small subset of experts dominates routing decisions.", isCorrect: true },
...

  {
    ...
    options: [
      { text: "It samples only the single most likely token.", isCorrect: false },
      { text: "It samples from a dynamically sized set based on cumulative probability.", isCorrect: true },
...

  {
    ...
    chapter: 3,
    difficulty: "hard",
    prompt: "Which statement correctly captures the purpose of auxiliary MoE losses?",
    options: [
      { text: "They increase vocabulary size.", isCorrect: false },
      { text: "They encourage balanced expert utilization.", isCorrect: true },
      { text: "They replace the main language modeling loss.", isCorrect: false },
      { text: "They eliminate the need for routing networks.", isCorrect: false },
    ],
    explanation:
...

  {
    ...
    options: [
      { text: "Models improve retrieval accuracy with longer context.", isCorrect: false },
      { text: "Models may struggle to retrieve relevant information as context grows.", isCorrect: true },
      { text: "Context rot is caused by overfitting during training.", isCorrect: false },
...

  {
    ...
    options: [
      ...
      { text: "The model is given instructions without examples.", isCorrect: true },
      { text: "The model updates its weights at inference time.", isCorrect: false },
...

  {
    ...
    chapter: 3,
    difficulty: "medium",
    prompt: "Which statements correctly describe Key–Value (KV) caching in Transformer inference?",
    options: [
      { text: "It stores key and value tensors from previous tokens.", isCorrect: true },
      { text: "It avoids recomputing attention components for past tokens.", isCorrect: true },
      { text: "It reduces redundant computation during autoregressive decoding.", isCorrect: true },
      { text: "It is primarily used during inference rather than training.", isCorrect: true },
    ],
    explanation:
...

  {
    ...
    chapter: 3,
    difficulty: "medium",
    prompt: "Which statements correctly describe why self-attention becomes expensive with long context lengths?",
    options: [
      { text: "Each new token must attend to all previous tokens.", isCorrect: true },
      { text: "Attention computation scales quadratically with sequence length.", isCorrect: true },
      { text: "Memory requirements grow with stored key–value tensors.", isCorrect: true },
      { text: "Longer contexts increase both compute and memory pressure.", isCorrect: true },
    ],
    explanation:
...

  {
    ...
    options: [
      { text: "Multiple query heads can share the same key and value heads.", isCorrect: true },
      { text: "It reduces memory usage of the KV cache.", isCorrect: true },
      { text: "It lies between multi-head attention and multi-query attention.", isCorrect: true },
      { text: "It is commonly used in modern large language models.", isCorrect: true },
    ],
    explanation:
...

  {
    ...
    options: [
      { text: "All query heads share a single set of key and value heads.", isCorrect: true },
      { text: "It significantly reduces KV cache memory usage.", isCorrect: true },
      { text: "It trades some expressiveness for efficiency.", isCorrect: true },
      { text: "It can improve inference speed for long contexts.", isCorrect: true },
    ],
    explanation:
...

  {
    ...
    chapter: 3,
    difficulty: "medium",
    prompt: "Which statements correctly describe PagedAttention-style memory management?",
    options: [
      { text: "It allocates KV cache memory in fixed-size blocks.", isCorrect: true },
      { text: "It reduces internal and external memory fragmentation.", isCorrect: true },
      { text: "It avoids reserving the full maximum context length upfront.", isCorrect: true },
      { text: "It improves scalability of serving multiple concurrent requests.", isCorrect: true },
    ],
    explanation:
...

  {
    ...
    chapter: 3,
    difficulty: "medium",
    prompt: "Which statements correctly describe latent (compressed) attention for KV caching?",
    options: [
      { text: "Keys and values are stored in a lower-dimensional latent space.", isCorrect: true },
      { text: "Compression reduces memory usage of the KV cache.", isCorrect: true },
      { text: "Decompression matrices reconstruct keys and values when needed.", isCorrect: true },
      { text: "Compression can be shared across attention heads.", isCorrect: true },
    ],
    explanation:
...

  {
    ...
    options: [
      { text: "A smaller draft model proposes multiple tokens.", isCorrect: true },
      { text: "A larger target model validates the proposed tokens.", isCorrect: true },
      { text: "Acceptance–rejection ensures correct target-model distribution.", isCorrect: true },
      { text: "It aims to generate multiple tokens per target-model forward pass.", isCorrect: true },
    ],
    explanation:
...

  {
    ...
    options: [
      { text: "The model predicts several future tokens at once.", isCorrect: true },
      { text: "Multiple prediction heads are trained jointly.", isCorrect: true },
      { text: "Draft and target predictions come from the same model.", isCorrect: true },
      { text: "It modifies the training objective compared to next-token prediction.", isCorrect: true },
    ],
    explanation:
...

  {
    ...
    chapter: 3,
    difficulty: "easy",
    prompt: "Which statements correctly describe the purpose of inference optimizations in LLMs?",
    options: [
      { text: "They reduce latency of text generation.", isCorrect: true },
      { text: "They lower memory usage during inference.", isCorrect: true },
      { text: "They improve throughput when serving many users.", isCorrect: true },
      { text: "They aim to preserve output quality while improving efficiency.", isCorrect: true },
    ],
    explanation:
...

  {
    ...
    options: [
      { text: "KV caching is generally unnecessary during teacher-forced training.", isCorrect: true },
      { text: "Training typically processes full sequences in parallel.", isCorrect: true },
      { text: "KV caching is mainly beneficial for autoregressive inference.", isCorrect: true },
      { text: "KV caching is required for gradient computation.", isCorrect: false },
    ],
    explanation:
...

  {
    ...
    chapter: 3,
    difficulty: "hard",
    prompt: "Which statements about routing decisions in MoE layers are correct?",
    options: [
      { text: "Routing is typically computed after the self-attention sublayer.", isCorrect: true },
      { text: "Routing decisions are based on token representations.", isCorrect: true },
      { text: "Each Transformer layer usually has its own router.", isCorrect: true },
      { text: "Routing is shared across all layers by default.", isCorrect: false },
    ],
    explanation:
...

  {
    ...
    chapter: 3,
    difficulty: "medium",
    prompt: "Which statements about speculative decoding efficiency are correct?",
    options: [
      { text: "It reduces the number of target-model forward passes.", isCorrect: true },
      { text: "It benefits from the fact that inference is often memory-bound.", isCorrect: true },
      { text: "It can generate several tokens per validation step.", isCorrect: true },
...

  {
    ...
    options: [
      { text: "It refers to degradation in effective information use with long contexts.", isCorrect: true },
      { text: "Distractor tokens can worsen retrieval performance.", isCorrect: true },
      { text: "It can occur even if the answer is present in the context.", isCorrect: true },
...

  {
    ...
    options: [
      { text: "Prompts can include context, instructions, input, and constraints.", isCorrect: true },
      { text: "Different prompt components serve different functional roles.", isCorrect: true },
      { text: "Constraints can restrict output format or content.", isCorrect: true },
      { text: "Prompt structure has no impact on model behavior.", isCorrect: false },
    ],
    explanation:
...

  {
    ...
    options: [
      { text: "It includes example input–output pairs in the prompt.", isCorrect: true },
      { text: "It often improves task performance.", isCorrect: true },
      { text: "It increases context length and inference cost.", isCorrect: true },
...

  {
    ...
    chapter: 3,
    difficulty: "hard",
    prompt: "Which statements about chain-of-thought interpretability are correct?",
    options: [
      { text: "It exposes intermediate reasoning steps as tokens.", isCorrect: true },
      { text: "It can help identify reasoning errors.", isCorrect: true },
      { text: "It makes debugging easier compared to opaque outputs.", isCorrect: true },
...

  {
    ...
    options: [
      { text: "Sampling introduces randomness into token selection.", isCorrect: true },
      { text: "Floating-point operations can introduce nondeterminism.", isCorrect: true },
      { text: "Parallel hardware execution can affect numerical results.", isCorrect: true },
      { text: "Determinism is guaranteed at temperature zero in practice.", isCorrect: false },
    ],
    explanation:
...

  {
    ...
    options: [
      ...
      { text: "They fundamentally change the model architecture.", isCorrect: false },
    ],
    explanation:
...

  {
    ...
    options: [
      { text: "Internal fragmentation refers to unused reserved memory.", isCorrect: true },
      { text: "External fragmentation refers to scattered free memory blocks.", isCorrect: true },
...

  {
    ...
    chapter: 3,
    difficulty: "hard",
    prompt: "Which statements about acceptance–rejection in speculative decoding are correct?",
    options: [
      { text: "Accepted tokens match the target model distribution.", isCorrect: true },
      { text: "Rejected tokens require resampling.", isCorrect: true },
      { text: "All draft tokens are always accepted.", isCorrect: false },
      { text: "Acceptance eliminates the need for validation.", isCorrect: false },
    ],
    explanation:
...

  {
    ...
    chapter: 3,
    difficulty: "medium",
    prompt: "Which statements about multi-token prediction objectives are correct?",
    options: [
      { text: "They differ from standard next-token prediction objectives.", isCorrect: true },
      { text: "They require predicting future tokens jointly.", isCorrect: true },
      { text: "They eliminate the need for autoregressive decoding.", isCorrect: false },
      { text: "They remove the need for attention mechanisms.", isCorrect: false },
    ],
    explanation:
...

  {
    ...
    options: [
      ...
      { text: "Both guarantee identical outputs across runs.", isCorrect: false },
...

  {
    ...
    options: [
      ...
      { text: "Probabilities are obtained after applying softmax.", isCorrect: true },
...

  {
    ...
    options: [
      { text: "Lower temperature sharpens the probability distribution.", isCorrect: true },
      { text: "Higher temperature flattens the distribution.", isCorrect: true },
...

  {
    ...
    options: [
      ...
      { text: "Active parameters per token can remain constant.", isCorrect: true },
      { text: "All parameters are used in every forward pass.", isCorrect: false },
      { text: "Capacity scaling removes the need for routing.", isCorrect: false },
    ],
    explanation:
...

  {
    ...
    options: [
      { text: "Inference is often memory-bound rather than compute-bound.", isCorrect: true },
      { text: "KV cache access can dominate latency.", isCorrect: true },
      { text: "More parameters always mean faster inference.", isCorrect: false },
...

  {
    ...
    options: [
      { text: "Behavior can be modified without fine-tuning.", isCorrect: true },
      { text: "Instructions influence generation style.", isCorrect: true },
      { text: "Prompting guarantees perfect adherence to constraints.", isCorrect: false },
...

  {
    ...
    options: [
      ...
      { text: "It avoids recomputing keys and values for past tokens.", isCorrect: true },
...

  {
    ...
    options: [
      ...
      { text: "Queries are grouped to share key and value heads.", isCorrect: true },
...

  {
    ...
    chapter: 3,
    difficulty: "hard",
    prompt: "Which statement best describes acceptance in speculative decoding?",
    options: [
      { text: "Draft tokens are always accepted.", isCorrect: false },
      { text: "Tokens are accepted when draft probability is consistent with target probability.", isCorrect: true },
...

  {
    ...
    options: [
      ...
      { text: "The maximum number of tokens processed in a single pass.", isCorrect: true },
...

  {
    ...
    chapter: 3,
    difficulty: "hard",
    prompt: "Which statement best explains why longer sequences have lower joint probability?",
    options: [
      { text: "Probabilities increase with each token.", isCorrect: false },
      { text: "Joint probability multiplies many values less than one.", isCorrect: true },
...

  {
    ...
    chapter: 3,
    difficulty: "medium",
    prompt: "Which statement best describes the main trade-off of chain-of-thought prompting?",
    options: [
      { text: "Lower accuracy for reasoning tasks.", isCorrect: false },
      { text: "Improved reasoning at the cost of more tokens.", isCorrect: true },
...

  {
    ...
    chapter: 3,
    difficulty: "easy",
    prompt: "Which statement best summarizes the goal of inference-time approximations?",
    options: [
      { text: "To retrain the model faster.", isCorrect: false },
      { text: "To reduce cost and latency with minimal quality loss.", isCorrect: true },
...

  {
    ...
    chapter: 3,
    difficulty: "easy",
    prompt: "Which statements correctly describe autoregressive text generation?",
    options: [
      { text: "Tokens are generated one at a time.", isCorrect: true },
      { text: "Each token is conditioned on previously generated tokens.", isCorrect: true },
      { text: "Generation stops based on a stopping criterion such as an end-of-sequence token.", isCorrect: true },
      { text: "The same model is reused at every decoding step.", isCorrect: true },
    ],
    explanation:
...

  {
    ...
    chapter: 3,
    difficulty: "medium",
    prompt: "Which statements correctly describe why greedy decoding can be suboptimal?",
    options: [
      { text: "It optimizes local token probability rather than global sequence probability.", isCorrect: true },
      { text: "Early token choices can restrict later high-probability continuations.", isCorrect: true },
      { text: "It cannot revise earlier decisions.", isCorrect: true },
      { text: "It often leads to repetitive or generic outputs.", isCorrect: true },
    ],
    explanation:
...

  {
    ...
    chapter: 3,
    difficulty: "medium",
    prompt: "Which statements correctly describe why beam search is rarely used for open-ended generation?",
    options: [
      { text: "It favors high-likelihood but low-diversity outputs.", isCorrect: true },
      { text: "It tends to converge to similar or generic sequences.", isCorrect: true },
      { text: "It optimizes likelihood rather than creativity.", isCorrect: true },
      { text: "It increases computational cost relative to sampling.", isCorrect: true },
    ],
    explanation:
...

  {
    ...
    options: [
      { text: "Tokens are sampled according to a probability distribution.", isCorrect: true },
      { text: "Higher-probability tokens are more likely to be selected.", isCorrect: true },
      { text: "Low-probability tokens can still be sampled.", isCorrect: true },
      { text: "Sampling introduces nondeterminism into generation.", isCorrect: true },
    ],
    explanation:
...

  {
    ...
    chapter: 3,
    difficulty: "medium",
    prompt: "Which statements correctly describe the effect of temperature on softmax?",
    options: [
      { text: "Temperature rescales logits before normalization.", isCorrect: true },
      { text: "Lower temperature increases confidence in top tokens.", isCorrect: true },
      { text: "Higher temperature increases entropy of the distribution.", isCorrect: true },
      { text: "Temperature influences sampling behavior without changing model weights.", isCorrect: true },
    ],
    explanation:
...

  {
    ...
    chapter: 3,
    difficulty: "medium",
    prompt: "Which statements correctly describe the motivation for Mixture-of-Experts models?",
    options: [
      { text: "To increase model capacity without linearly increasing compute.", isCorrect: true },
      { text: "To activate only a subset of parameters per token.", isCorrect: true },
      { text: "To scale to very large parameter counts.", isCorrect: true },
      { text: "To reduce inference cost compared to dense models of equal size.", isCorrect: true },
    ],
    explanation:
...

  {
    ...
    chapter: 3,
    difficulty: "hard",
    prompt: "Which statements correctly describe why the feed-forward network is the usual location for MoE layers?",
    options: [
      { text: "It contains a large fraction of the model’s parameters.", isCorrect: true },
      { text: "It dominates FLOPs compared to attention layers.", isCorrect: true },
      { text: "Replacing it yields significant capacity gains.", isCorrect: true },
      { text: "It preserves the structure of attention mechanisms.", isCorrect: true },
    ],
    explanation:
...

  {
    ...
    chapter: 3,
    difficulty: "medium",
    prompt: "Which statements correctly describe why routing is performed at the token level?",
    options: [
      { text: "Different tokens may require different expert specializations.", isCorrect: true },
      { text: "Token-level routing increases expressiveness.", isCorrect: true },
      { text: "Routing can adapt dynamically to context.", isCorrect: true },
      { text: "It allows fine-grained allocation of compute.", isCorrect: true },
    ],
    explanation:
...

  {
    ...
    prompt: "Which statements about top-k sampling are correct?",
    options: [
      { text: "It limits sampling to the k most likely tokens.", isCorrect: true },
      { text: "It prevents extremely unlikely tokens from being selected.", isCorrect: true },
      { text: "It preserves stochasticity within the selected set.", isCorrect: true },
...

  {
    ...
    chapter: 3,
    difficulty: "hard",
    prompt: "Which statements about auxiliary MoE load-balancing losses are correct?",
    options: [
      { text: "They penalize uneven expert utilization.", isCorrect: true },
      { text: "They encourage more uniform routing distributions.", isCorrect: true },
...

  {
    ...
    options: [
      ...
      { text: "It can enforce structured output constraints.", isCorrect: true },
...

  {
    ...
    options: [
      { text: "Longer context increases attention computation cost.", isCorrect: true },
      { text: "Very long contexts can degrade retrieval accuracy.", isCorrect: true },
      { text: "Context rot can occur even when answers are present.", isCorrect: true },
...

  {
    ...
    options: [
      { text: "It uses a smaller draft model to propose tokens.", isCorrect: true },
      { text: "It validates draft tokens using a larger target model.", isCorrect: true },
      { text: "It preserves the target model’s output distribution.", isCorrect: true },
...

  {
    ...
    options: [
      { text: "The model predicts multiple future tokens per step.", isCorrect: true },
...

  {
    ...
    prompt: "Which statements about chain-of-thought prompting are correct?",
    options: [
      { text: "It encourages explicit intermediate reasoning.", isCorrect: true },
...

  {
    ...
    options: [
      { text: "It adapts behavior without updating model weights.", isCorrect: true },
      { text: "It relies on information provided in the prompt.", isCorrect: true },
...

  {
    ...
    options: [
      ...
      { text: "It relies on the model’s pretrained knowledge.", isCorrect: true },
...

  {
    ...
    options: [
      { text: "They limit how many tokens can be attended to.", isCorrect: true },
...

  {
    ...
    options: [
      ...
      { text: "Floating-point arithmetic can cause variation.", isCorrect: true },
...

  {
    ...
    chapter: 3,
    difficulty: "hard",
    prompt: "Which statements about approximate inference techniques are correct?",
    options: [
...

  {
    ...
    chapter: 3,
    difficulty: "easy",
    prompt: "Which statement best describes why sampling produces different outputs?",
    options: [
      { text: "The model weights change at inference time.", isCorrect: false },
      { text: "Randomness is introduced during token selection.", isCorrect: true },
      { text: "The Transformer is nondeterministic internally.", isCorrect: false },
...

  {
    ...
    options: [
      ...
      { text: "Relevant information becomes harder to retrieve in long contexts.", isCorrect: true },
...

  {
    ...
    chapter: 3,
    difficulty: "hard",
    prompt: "Which statement best explains why MoE models can reach trillions of parameters?",
    options: [
      { text: "All parameters are used in every forward pass.", isCorrect: false },
      { text: "Only a subset of experts is activated per token.", isCorrect: true },
      { text: "Attention layers scale linearly with parameters.", isCorrect: false },
      { text: "Routing removes the need for large datasets.", isCorrect: false },
    ],
    explanation:
...

  {
    ...
    chapter: 3,
    difficulty: "medium",
    prompt: "Which statement best describes the main benefit of speculative decoding?",
    options: [
      { text: "Improved training convergence.", isCorrect: false },
      { text: "Faster inference with preserved output distribution.", isCorrect: true },
...

  {
    ...
    options: [
      ...
      { text: "It conditions model behavior through context.", isCorrect: true },
...

  {
    ...
    chapter: 3,
    difficulty: "easy",
    prompt: "Which statement best captures the overarching theme of modern LLM design?",
    options: [
      { text: "Maximize parameter count regardless of cost.", isCorrect: false },
      { text: "Balance scale, efficiency, and controllability.", isCorrect: true },
