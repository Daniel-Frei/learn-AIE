...
export const L1_IntroductionToNeuralNetworksAndDeepLearning: Question[] = [
...

  {
    ...
    difficulty: "medium",
    prompt:
      "Which factors help explain why deep learning has become especially dominant in recent years?",
    options: [
      {
        text: "The availability of large datasets has increased substantially.",

        isCorrect: true,
      },
      {
        text: "Modern hardware such as Graphics Processing Units enables large-scale parallel computation.",
        isCorrect: true,
      },
      {
        text: "Software frameworks and toolboxes have made training and deployment much more accessible.",
        isCorrect: true,
      },
      {
        text: "It is not the case that The main reason is that neural networks were only invented recently.",
        isCorrect: true,
      },
    ],
    explanation:
      "The lecture explicitly highlights three main reasons for the modern rise of deep learning: big data, hardware, and software. Neural networks themselves are not new; what changed is the ecosystem around them, including data availability, Graphics Processing Units, and practical frameworks such as TensorFlow and PyTorch.",
  },
...

  {
    ...
    difficulty: "medium",
    prompt:
      "Which statements about hierarchical feature learning in deep neural networks are correct?",
    options: [
      {
        text: "Lower layers often learn simple features such as lines and edges.",

        isCorrect: true,
      },
      {
        text: "Intermediate layers can combine simpler patterns into parts such as eyes, noses, or ears.",
        isCorrect: true,
      },
      {
        text: "Higher layers can represent more abstract structures such as full facial configurations.",
        isCorrect: true,
      },
      {
        text: "It is not the case that Hierarchical feature learning means every layer learns the same type of representation.",
        isCorrect: true,
      },
    ],
    explanation:
      "A central motivation for deep learning is that it can learn features directly from data in a layered, hierarchical way. The lecture shows this progression clearly: simple visual patterns in early layers, more meaningful parts in middle layers, and high-level concepts such as facial structure in deeper layers.",
  },
...

  {
    ...
    difficulty: "hard",
    prompt:
      "For a binary classification problem where the model predicts a value between \\(0\\) and \\(1\\), which statements are correct?",
    options: [
      {
        text: "A sigmoid activation is a natural output choice because it maps real values to the interval \\((0,1)\\).",
        isCorrect: true,
      },
      {
        text: "The output can be interpreted as a probability for one of the two classes.",
        isCorrect: true,
      },
      {
        text: "Cross-entropy loss is commonly used to compare predicted probabilities against the true binary labels.",
        isCorrect: true,
      },
      {
        text: "Mean squared error is the only valid loss for binary classification.",
        isCorrect: false,
      },
    ],
    explanation:
      "In the lecture's pass/fail example, the model outputs a probability between zero and one, which ties directly to the sigmoid activation. Cross-entropy is then used as a natural loss for matching predicted probabilities to binary targets, whereas mean squared error is more naturally associated with continuous-value regression.",
  },
...

  {
    ...
    difficulty: "medium",
    prompt:
      "Which statements about the broader current deep learning landscape are correct?",
    options: [
      {
        text: "Recent progress has extended from image generation into natural language and multimodal systems.",
        isCorrect: true,
      },
      {
        text: "Modern deep learning includes both very large cloud-based models and much smaller models that can run on edge devices.",
        isCorrect: true,
      },
      {
        text: "End-to-end audio models can process speech directly without first converting it into text tokens.",
        isCorrect: true,
      },
      {
        text: "Recent advances are limited to data-center-scale systems and have not reached small devices.",
        isCorrect: false,
      },
    ],
    explanation:
      "The first part of the lecture emphasizes the speed of progress in the field, moving from image generation to language and multimodal AI. It also highlights that deep learning now spans both massive cloud models and smaller models that can run directly on phones or other edge devices.",
  },
